...
public class EditProfile {
	...
	public void user_fills_up_all_the_mandatory_fields() {
	    driver.findElement(By.name("firstname")).sendKeys("Apple"); //first name
	    driver.findElement(By.name("lastname")).sendKeys("Watch"); //last name
	    driver.findElement(By.name("email")).sendKeys("apple@watch.com"); //email
	    driver.findElement(By.name("username")).sendKeys("applewatch"); //username
